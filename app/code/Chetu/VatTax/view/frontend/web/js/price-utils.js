...
define(
    ["jquery", "underscore"], function ($, _) {
        ...
        function formatPrice(amount, format, isShowSign)
        {
            ...
            var string = "window.checkoutConfig.checkoutUrl";
            var substring = "checkout";
            if (string.indexOf(substring) !== -1 
                && window.checkoutConfig != undefined 
                && window.checkoutConfig.quoteData != undefined 
                && window.checkoutConfig.quoteData.subtotal != amount
            ) {
                precision = 2;
            } else {
                precision = 0;
